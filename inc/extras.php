...
//   wp_register_style( 'zz_tc_button_css', get_template_directory_uri() . '/css/zz-btns.css', false, '1.0.0' );
//   wp_enqueue_style( 'zz_tc_button_css' );
// }

// // Create the custom TinyMCE plugins
// function zz_add_tinymce_plugin($plugin_array) {
//   $plugin_array['zz_tc_simple'] = get_template_directory_uri() . '/assets/js/zz-btns.js';
//   $plugin_array['zz_tc_button'] = get_template_directory_uri() . '/assets/js/zz-btns.js';
//   $plugin_array['zz_tc_list'] = get_template_directory_uri() . '/assets/js/zz-btns.js';
//   return $plugin_array;
// }
